...
> Updated 2026-08-19 for the BSD/WebKit strategy.
...
4. `ARCHITECTURE.md` and `UI_PLATFORM.md` for current/target boundaries
...
- `ARCHITECTURE.md` — current native and target WebKit architecture
- `UI_PLATFORM.md` — runtime, bridge, security and migration design
- `PROJECT_STATUS.md` — current implemented state
- `GUI_CENTRALIZATION_PLAN.md` — binding native/CSS token pipeline and DoD
...
- `TESTING.md` — native, WebKit-target and platform validation
- `PERFORMANCE_RULES.md` / `VISUAL_PERFORMANCE.md` — native/WebKit budgets
