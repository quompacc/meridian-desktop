...
pub(crate) struct MeridianShell {
    ...
    pub(crate) settings_layer: LayerSurface,
    ...
    pub(crate) settings_configured: bool,
    ...
    pub(crate) settings_buffer: Option<Buffer>,
    ...
    pub(crate) settings_width: u32,
    pub(crate) settings_height: u32,
